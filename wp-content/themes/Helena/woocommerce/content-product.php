...
?>
<li <?php post_class( $classes ); ?> style="<?php echo esc_attr( $shop_style ); ?>" <?php echo wp_kses_post( $shop_attr ); ?>>
	...
	echo '<div class="product-thumbnail">';
		...
		echo '<div class="buttons product-buttons">';
			...
			echo '<a class="agni-quick-view-btn" href="#" data-product-id="'.esc_attr( $product->get_id() ).'">'.esc_html__( 'Quick View', 'halena' ).'</a>';
