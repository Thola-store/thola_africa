...
<div class="wrap about-wrap agni-welcome-page-wrap">
    ...
    <h2 class="nav-tab-wrapper wp-clearfix">
        <a href="<?php echo esc_url( admin_url() ); ?>admin.php?page=halena&tab=welcome" class="nav-tab <?php echo ( $active_tab == 'welcome' ) ? 'nav-tab-active' : ''; ?>"><?php esc_html_e( 'Welcome', 'halena' ); ?></a>
        <a href="<?php echo esc_url( admin_url() ); ?>admin.php?page=halena&tab=system_status" class="nav-tab <?php echo ( $active_tab == 'system_status' ) ? 'nav-tab-active' : ''; ?>"><?php esc_html_e( 'System Status', 'halena' ); ?></a>
        <a href="<?php echo esc_url( admin_url() ); ?>admin.php?page=halena&tab=help" class="nav-tab <?php echo ( $active_tab == 'help' ) ? 'nav-tab-active' : ''; ?>"><?php esc_html_e( 'Help', 'halena' ); ?></a>
    </h2>

    <?php if( $active_tab == 'welcome' ) { ?>
        <div id="welcome" class="agni-welcome">
        	<h3><?php esc_html_e( '1 - Install & Activate Required Plugins', 'halena' ); ?></h3>
			<p><?php esc_html_e( 'Agni Halena & Visual Composer are mandatory plugins to make all the theme features available. Halena also includes few additional plugins to enhance the theme functionalities further.', 'halena' ); ?></p> 
			<small><?php esc_html_e( 'Note: You don\'t need to enter the product license for Visual Composer separately. Since, it\'s bundled with theme, theme author holds the license for each visual composer activation.', 'halena' ); ?></small>
			<p><a class="button button-primary button-large" href="<?php echo admin_url(); ?>admin.php?page=halena-install-plugins"><?php esc_html_e( 'Install & Activate', 'halena' ); ?></a></p>
        	<h3><?php esc_html_e( '2 - Customize at Option Panel', 'halena' ); ?></h3>
        	<p><?php esc_html_e( 'Option panel powered by Redux Framework will help you to customize the options (such as colors, fonts, typography, etc.) for the website according to your need. There are tons of settings/options available to customize. Even you can backup (export) & import your settings by using option panel.', 'halena' ); ?></p>
			<p><a class="button button-primary button-large" href="<?php echo admin_url(); ?>admin.php?page=halena-theme-options"><?php esc_html_e( 'Option Panel', 'halena' ); ?></a></p>
        </div>
        ...
        <div id="system-status" class="feature-section agni-system-status">
			...
			<table class="widefat" cellspacing="0">
				...
				<tbody>
					...
					<tr>
						<td data-export-label="Server Info"><?php esc_html_e( 'Server Info', 'halena' ); ?>:</td>
    ...
    <?php } else { ?>
    	<div id="help" class="agni-help feature-section two-col">
    		<div class="col">
    			...
    			<a class="button button-primary" href="<?php echo esc_url( 'demo.agnidesigns.com/doc/halena/' ); ?>"><?php esc_html_e( 'See Documentation', 'halena' ); ?></a>
    		</div>
    		<!--<div class="col">
    		...
    		<div class="col">
    			...
    			<a class="button button-primary" href="<?php echo esc_url( 'https://themeforest.net/item/halena-minimal-modern-ecommerce-wordpress-theme/21142525/support' ); ?>"><?php esc_html_e( 'Create Ticket', 'halena' ); ?></a>
    		</div>
        </div>
    <?php } ?>
