...
class TA_WC_Variation_Swatches_Frontend {
	...
	public function enqueue_scripts() {
		wp_enqueue_style( 'tawcvs-frontend', AGNI_THEME_FILES_URL . '/variation-swatches-for-woocommerce/assets/css/frontend.css', array(), '20160615' );
		wp_enqueue_script( 'tawcvs-frontend', AGNI_THEME_FILES_URL . '/variation-swatches-for-woocommerce/assets/js/frontend.js', array( 'jquery' ), '20160615', true );
	}
