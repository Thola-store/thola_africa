...
if ( !class_exists( 'AGNIDGWT_WC_Ajax_Search' ) ) {
	...
	final class AGNIDGWT_WC_Ajax_Search {
		...
		private function constants() {
			...
			$this->define( 'AGNIDGWT_WCAS_DIR', get_template_directory() .'/agni/ajax-search-for-woocommerce/' );
			$this->define( 'AGNIDGWT_WCAS_URL', get_template_directory_uri() .'/agni/ajax-search-for-woocommerce/' );
