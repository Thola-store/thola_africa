 ...
 * Custom menu items
 */
require AGNI_THEME_FILES_DIR . '/menu-image/menu-image.php';
...
function agni_framework_theme_custom_functions() {
	...
	// Theme option panel value customizations
   	...
   	if( class_exists( 'WooCommerce' ) ){
		...
		require AGNI_THEME_FILES_DIR . '/ajax-product-filter/wcapf.php';

		// Include custom plugin for ajax product filter
		require AGNI_THEME_FILES_DIR . '/variation-swatches-for-woocommerce/variation-swatches-for-woocommerce.php';

		// Include custom plugin for ajax product filter
		require AGNI_THEME_FILES_DIR . '/side-cart-woocommerce/xoo-wsc.php';

		// Include Ajax Product search
		require AGNI_THEME_FILES_DIR . '/ajax-search-for-woocommerce/ajax-search-for-woocommerce.php';
