...
class halena_about_text extends WP_Widget {
	...
	public function __construct(){
		...
		parent::__construct(
			'halena_about_text',
			esc_html__( 'Halena: About Text', 'halena' ),
				array(
					'classname'   => 'widget_halena_about_text',
					'description' => esc_html__( 'Extented version of text widget which allows you to set image & heading.', 'halena' )
				)
			);			
	...
	public function form( $instance ) {
		$defaults = array( 'title' => esc_html__('About Me', 'halena'), 'heading' => '', 'image_id' => '', 'description' => '');
		...
		<p>
		 ...
		 <p>
            ...
            <button class="set_custom_images button"><?php esc_html_e('Add Image', 'halena'); ?></button>
        </p>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'heading' ) ); ?>"><?php esc_html_e('Heading:', 'halena'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'description' ) ); ?>"><?php esc_html_e('Description:', 'halena'); ?></label>
