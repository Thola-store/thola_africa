...
function agni_page_header_meta() {
	...
	$page_header_option->add_field( array(  
		...
		'desc'	=> esc_html__('video url only from youtube!', 'halena' ), 
...
function agni_slider_meta() {
	...
	$slideshow_slider_options->add_field( array(
		'name' => esc_html__('Margin(Gutter)', 'halena' ),
		'desc' => esc_html__('Enter the margin amount between each item.', 'halena' ),
	...
	$slideshow_slider_options->add_field( array( 
		'name'	=> esc_html__('Transition Duration & Speed', 'halena' ), 
	...
	$slideshow_slider_options->add_field( array(
		'name'	=> esc_html__('Animation In & Out', 'halena' ),
