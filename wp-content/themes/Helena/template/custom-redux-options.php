    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'required' => array('header-additional-primary-menu-button', '=', '1'),
                'transparent' => false,
                'output' => array( '.has-additional-primary-menu-button ul.nav-additional-primary-menu-content >li:last-child >a, .has-additional-primary-menu-button div.nav-additional-primary-menu-content >ul >li:last-child >a' ), 
                'mode' => 'border-color',
                'title' => esc_html__('Button Border color ', 'halena'),
                'default' => '#1e1e20',
                'validate' => 'color',
        ...
        Redux::setSection( $opt_name, array(
            ...
            'fields' => array(
                ...
                array(
                    ...
                    'type' => 'image_select',
                    'title' => esc_html__('Shop Layout(Columns)', 'halena'),
                    'subtitle' => esc_html__('Layout for your Shop page ', 'halena'),
                    'desc' => esc_html__('Choose an image to your shop page', 'halena'),
                    'options' => array(
                        '1' => array('alt' => '1 Column', 'img' => AGNI_FRAMEWORK_URL . '/template/img//portfolio-1c.png'),
