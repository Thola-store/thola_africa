	        ...
	        $this.on('click', function(e){
				...
				if ( $thisbutton.is( '.ajax_add_to_cart' ) ) {
					...
					if($('body').find('.agni-ajax-add-to-cart-loader').length !== 0){
						...
						$('body').prepend('<div id="agni-ajax-add-to-cart-loader" class="agni-ajax-add-to-cart-loader agni-add-to-cart-loader-visible">Adding to Cart!</div>');
					}
		...
		$.fn.agni_quick_view = function(){
			...
			$this.on('click', function(e){
				...
				if( !$('.agni-quick-view-wrap').length ){
					$('body').append('<div class="agni-quick-view-wrap"><div class="agni-quick-view-overlay"></div><div class="agni-quick-view-close"></div><div class="agni-quick-view-content"></div><div class="agni-quick-view-preloader">Loading!</div></div>');
				}
				else{
