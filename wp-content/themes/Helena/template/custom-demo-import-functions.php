...
if ( !function_exists( 'wbc_importer_description_text' ) ) {
	...
	function wbc_importer_description_text( $description ) {
		...
		$message .= '<p><strong style="color:red;">'. esc_html__( 'This process may take serveral minutes to complete. Please be patience :) If the process bar stops working, refresh the page and click "Import Demo" again.', 'halena' ) .'</strong></p>';
